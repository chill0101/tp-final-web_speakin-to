            ...
            <div class="flex">
                ...
                <div class="hidden space-x-4 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user() && Auth::user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('attachments.index')" :active="request()->routeIs('attachments.*')">
                            {{ __('Archivos Adjuntos') }}
                        </x-nav-link>
                    @elseif(Auth::user() && Auth::user()->role === 'professor')
                        <x-nav-link :href="route('courses.index')" :active="request()->routeIs('courses.*')">
                            {{ __('Mis Cursos') }}
                        </x-nav-link>
                        <x-nav-link :href="route('enrollments.index')" :active="request()->routeIs('enrollments.*')">
                        ...
                        <x-nav-link :href="route('attachments.index')" :active="request()->routeIs('attachments.*')">
                            {{ __('Materiales y Archivos') }}
                        </x-nav-link>
                    @elseif(Auth::user() && Auth::user()->role === 'coordinator')
                        <x-nav-link :href="route('students.index')" :active="request()->routeIs('students.*')">
                            {{ __('Alumnos') }}
                        </x-nav-link>
                        <x-nav-link :href="route('enrollments.index')" :active="request()->routeIs('enrollments.*')">
